...
class Cube:
    def __init__(self):
        ...
        self.img_data = self.generate_text("Hello Cube!")
    ...
    def generate_text(self,text):
        ...
        img = Image.new("RGBA", self.size, color = (0,0,0,1))
        ...
        draw.text(((self.size[0] - w) / 2, (self.size[1] - h) / 2), text, fill=(255, 255, 255), font=font)
